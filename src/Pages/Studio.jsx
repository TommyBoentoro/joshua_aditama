        ...
        return(
            <>
                    ...
                    <div className="container d-flex flex-column align-items-center fontlato" >
                        <div className="col-lg-11 col-md-12 d-flex fontheadingstudio padding100"  style={{ fontWeight:"300"}}>
                            Turning Spatial Experience Into a work of art.
                        </div>
                        <div className="col-lg-11 col-md-12 d-flex flex-column margin80" >
                            <div className="fontsubheading-studio" style={{fontWeight:"700", letterSpacing:"0.025cm", lineHeight:"100%"}}>
                                Joshua Aditama, B. Des.
                            </div>
                            <div className="fontbody" style={{fontWeight:"400", letterSpacing:"0.025cm", marginTop:"10px"}}>
                                Principal Designer
                            </div>
                            <div className="fontbody" style={{fontWeight:"300", letterSpacing:"0.025cm", color:"#8f8f8f", marginTop:"30px"}}>
                    ...
                    <div className="container d-flex flex-column fontlato align-items-center marginservice">
                        ...
                        <div className="col-md-10 col-12 border" style={{marginTop:"80px"}}>
                            <div className="col d-md-flex ">
                                <div className="col-md-6 border">
                                    ...
                                    <div className="textcard-body mt-md-4 mt-3" style={{ fontWeight:"300", color:"#8F8F8F", width:"90%",letterSpacing:"0.025cm"}}>
                                ...
                                <div className="col-md-6 border margincard ml-md-5" >
                                    <div style={{fontSize:"16px", fontWeight:"700"}}> {/* CARD */}
                                        02.
                                    </div>
                                    <div className="textcard-heading mt-1" style={{fontWeight:"300"}}>
