            ...
            <>
                    <div className=" backgroundstudio1" style={{width: "100%", height: "900px"}}>
                            <div className="d-flex container  flex-column fontlato justify-content-end" style={{height: "900px", paddingBottom:"100px"}}>
                                ...
                                <div className=" " style={{width:"100%", backgroundColor:"black", height:"3px", opacity:"50%", marginTop:"30px"}}>
                    ...
                    <div className="container   d-flex flex-column align-items-center fontlato" >
                        <div className="col-10 d-flex "  style={{paddingTop:"100px", fontSize:"50px", fontWeight:"300"}}>
                            Turning Spatial Experience Into a Work of Art.
                        </div>
                        <div className="col-10 d-flex flex-column " style={{marginTop:"80px"}}>
                            <div style={{fontSize:"21px", fontWeight:"700", letterSpacing:"0.025cm", lineHeight:"100%"}}>
                                Joshua Aditama, B. Des.
                            </div>
                            <div style={{fontSize:"17px", fontWeight:"400", letterSpacing:"0.025cm", marginTop:"10px"}}>
                                Principal Designer
                            </div>
                            <div style={{fontSize:"17px", fontWeight:"400", letterSpacing:"0.025cm", color:"#8f8f8f", marginTop:"30px"}}>
